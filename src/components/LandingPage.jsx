  ...
  return (
    <>
      ...
      <NavsTwo
        ...
        btns={<MyButton>Cyper AI</MyButton>}
      />
      <BigContainer className="pt-16 ">
        <HeroFunc IncidentText="View Incidents" Links={"/Incidents"} />
      </BigContainer>
        ...
        <div className=" float-end relative mb-12 mr-3 sm:mr-20 ">
          ...
          <img
            ...
            className={`cursor-pointer ${
              chat ? `hidden` : `flex`
            } w-14 md:w-auto absolute -bottom-20 md:-right-10 right-5 transition hover:scale-95`}
            alt=""
            onClick={openChat}
          />
          <div
            className={`bg-white customShadow px-3 absolute -bottom-20 md:-right-10 right-5 transition hover:scale-95 text-black cursor-pointer font-semibold py-3 text-3xl md:text-5xl  ${
              chat ? `flex` : `hidden`
